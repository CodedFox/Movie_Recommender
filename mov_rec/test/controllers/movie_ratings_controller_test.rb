...
class MovieRatingsControllerTest < ActionController::TestCase
  ...
  test "should create movie_rating" do
    assert_difference('MovieRating.count') do
      post :create, movie_rating: { date_watched: @movie_rating.date_watched, movie_id: @movie_rating.movie_id, review: @movie_rating.review, user_id: @movie_rating.user_id, user_rating: @movie_rating.user_rating }
    end
  ...
  test "should update movie_rating" do
    patch :update, id: @movie_rating, movie_rating: { date_watched: @movie_rating.date_watched, movie_id: @movie_rating.movie_id, review: @movie_rating.review, user_id: @movie_rating.user_id, user_rating: @movie_rating.user_rating }
    assert_redirected_to movie_rating_path(assigns(:movie_rating))
  end
