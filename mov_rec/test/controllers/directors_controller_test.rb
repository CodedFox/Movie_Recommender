...
class DirectorsControllerTest < ActionController::TestCase
  ...
  test "should create director" do
    assert_difference('Director.count') do
      post :create, director: { first_name: @director.first_name, last_name: @director.last_name, place_of_birth: @director.place_of_birth }
    end
  ...
  test "should update director" do
    patch :update, id: @director, director: { first_name: @director.first_name, last_name: @director.last_name, place_of_birth: @director.place_of_birth }
    assert_redirected_to director_path(assigns(:director))
  end
